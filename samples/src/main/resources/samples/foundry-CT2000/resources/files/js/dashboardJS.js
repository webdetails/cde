define(['cdf/lib/jquery', 'amd!cdf/lib/underscore', 'cdf/lib/CCC/protovis', 
        'cdf/Dashboard.Clean',  'cdf/lib/CCC/pvc', 'cdf/lib/CCC/def', 
        'cdf/dashboard/Utils'],
        function($, _, pv, Dashboard, pvc, def, Utils ) {
    ...
    var CT2000JS = {
        configurations: {
            charts: {
                    ...
                    baseAxisTitleMargins: { top: 10, left: -6 },
                    orthoAxisTitleMargins: { right: 10, top: -7 },
