...
/**
 * The only thing this class does is to replace the source settings.xml file with the one placed at test-resources
 */
public class CdfDDSettingsForTesting extends CdeSettings.CdfDDSettings {

  private static final String SETTINGS_XML = "test-resources/settings.xml";
