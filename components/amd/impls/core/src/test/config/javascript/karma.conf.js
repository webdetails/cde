...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'src/main/javascript/**/*.+(js|css)', included: false},
      ...
      // fix 404 messages
      {pattern: 'src/main/javascript/**/*.+(png|gif|html)', watched: false, included: false, served: true},
    ...
    //preprocessors: {'src/main/javascript/**/*.js': 'coverage'},
