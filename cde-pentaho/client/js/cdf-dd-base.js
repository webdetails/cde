var Endpoints = {
	...
	getStaticUrl: function(){ return this.staticUrl },
	setStaticUrl: function(){ this.staticUrl = staticUrl },

    getPluginUrl: function(){ return this.pluginUrl },
    setPluginUrl: function(id){ this.pluginUrl = pluginUrl },

	getCssResourceUrl: function(){ return this.pluginUrl + this.cssResourceUrl },
	setCssResourceUrl: function(id){ this.cssResourceUrl = cssResourceUrl },

	getImageResourceUrl: function(){ return this.pluginUrl + this.imageResourceUrl },
	setImageResourceUrl: function(id){ this.imageResourceUrl = imageResourceUrl },

	getJsResourceUrl: function(){ return this.pluginUrl + this.jsResourceUrl },
	setJsResourceUrl: function(id){ this.jsResourceUrl = jsResourceUrl }	
