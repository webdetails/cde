define("cde/components/Map/Map.lifecycle", ["amd!cdf/lib/underscore"], function(_) {
  ...
  return MapEngine.extend({
    ...
    setPanningMode: function() {
      return this._removeListeners(), this._updateMode("pan"), this._updateDrag(!1), this.map.setOptions({
        draggingCursor: "inherit",
        draggableCursor: "inherit",
        draggable: !0
      }), void 0;
    ...
    setSelectionMode: function() {
      ...
      }, onMouseUpOverMap = this._endBox(control, isSelectionMode, addFeaturesInBoundsToSelection, this._createClickHandler(function(me) {
