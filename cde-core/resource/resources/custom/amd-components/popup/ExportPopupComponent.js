...
define(
  ['./PopupComponent', './ExportPopupComponentExt', 'cdf/dashboard/Utils', 'cdf/Logger', 'cdf/lib/jquery', 'css!./ExportPopupComponent'],
  function(PopupComponent, ExportPopupComponentExt, Utils, Logger, _, $) {
...
var ExportPopupComponent = PopupComponent.extend({
  ...
  exportChart: function(cet){
    ...
    var url = ExportPopupComponentExt.getCggDrawUrl() + "?script=" + loc +  this.chartExportComponent + ".js&outputType=" + effectiveExportType;
