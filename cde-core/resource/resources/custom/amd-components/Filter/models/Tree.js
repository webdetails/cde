...
define([
    ...
    'amd!../lib/backbone.treemodel',
    '../lib/basebone',
    '../base/Filter-base-implementation'],
    function(  _, Backbone, BaseBone, BaseFilter ) {

    BaseFilter.Models.Tree = BaseBone.extendWithEvents( Backbone.TreeModel ).extend( BaseFilter.Logger ).extend({
        url: '',
        children: function() {
