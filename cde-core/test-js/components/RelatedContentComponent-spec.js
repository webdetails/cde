...
define(['cdf/Dashboard', 'cde/components/RelatedContentComponent'],
  ...
  describe("The Related Content Component #", function() {
    ...
    var relatedContentComponent = new RelatedContentComponent(dashboard, {
      ...
      priority: 5,
      relatedContent: [["Pentaho","http://www.pentaho.com/"],["Pentaho Community","http://community.pentaho.com/"],["Webdetails","http://www.webdetails.pt/"]],
      executeAtStart: true
    });
    ...
    /**
     * ## The Related Content Component # Update Called
     */
