...
var ComponentsPanel = Panel.extend({
		...
		init: function(){
			...
			componentsTableModel.setRowId(function(row){return row.id});
			componentsTableModel.setRowType(function(row){return row.type});
			componentsTableModel.setParentId(function(row){return row.parent});
		...
		setComponentsPallete: function(componentsPallete){this.componentsPallete = componentsPallete},
		getComponentsPallete: function(){return this.componentsPallete},
		setComponentsArray: function(componentsArray){this.componentsArray = componentsArray},
		getComponentsArray: function(){return this.componentsArray}
